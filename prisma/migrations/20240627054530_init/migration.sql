...
CREATE TABLE "faculties" (
    ...
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "acdemicDepartmentId" TEXT NOT NULL,
    "academicFacultyId" TEXT NOT NULL,
...
-- AddForeignKey
ALTER TABLE "faculties" ADD CONSTRAINT "faculties_acdemicDepartmentId_fkey" FOREIGN KEY ("acdemicDepartmentId") REFERENCES "academic_department"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
